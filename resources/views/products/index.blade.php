                ...
                <div class="flex gap-4">
                    @if (auth()->user()->isAdmin())
                        <a href="{{ route('products.trashed') }}"
                            class="bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition duration-200">
                            🗂️ Trashed Products
                        </a>
                    @endif
                            ...
                            <div class="mb-3">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    @if ($product->stock_quantity !== null)
                                        <span
                                            class="text-sm {{ $product->stock_quantity > 0 ? 'text-green-600' : 'text-red-600' }}">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 mb-6">
                    @if (request('search'))
                        No products match your search criteria. Try different keywords or <a
                            href="{{ route('products.index') }}" class="text-blue-600 hover:underline">clear the
                            search</a>.
                    @else
                ...
                @else
                    <p class="text-gray-500">Please <a href="{{ route('login') }}"
                            class="text-blue-600 hover:underline">login</a> to add products.</p>
                @endauth
            </div>
        @endif
    </div>
